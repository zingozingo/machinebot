...
def learn():
    ...
    <body>
        <div class="main-container">
            ...
            <div class="section">
                <h2><span class="step-number">2</span> Testing All 4 Features: Which Separates Best?</h2>
                <p style="font-size: 1.1em;">The algorithm tests EVERY feature to see which one best separates the flower types. Let's see why petals win!</p>
            ...
            <div class="section">
                <h2><span class="step-number">3</span> Why Petals Win: The 93% Importance Explained</h2>
    ...
    html += '''
            ...
            <div class="section">
                ...
                <p style="text-align: center; color: #666;">This tree has been trained on all 150 flowers and can now classify new flowers with 97% accuracy!</p>
            </div>
